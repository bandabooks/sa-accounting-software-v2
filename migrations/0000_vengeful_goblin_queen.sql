...
CREATE TABLE "ai_settings" (
	...
	"context_sharing" boolean DEFAULT true,
...
ALTER TABLE "ai_settings" ADD CONSTRAINT "ai_settings_company_id_companies_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "ai_settings_company_idx" ON "ai_settings" USING btree ("company_id");--> statement-breakpoint
