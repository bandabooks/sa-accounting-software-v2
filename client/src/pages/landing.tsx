  ...
  const features = [
    {
      ...
      description:
        "Full-featured accounting with invoicing, expenses, and financial reports",
  ...
  const testimonials = [
    {
      ...
      content:
        "Taxnify has revolutionized our practice. We've reduced our compliance work by 60% and can now focus on growing our client base.",
      rating: 5,
    },
    {
      name: "Michael Chen",
      ...
      content:
        "The VAT compliance features are exceptional. We haven't had a single SARS query since switching to Taxnify.",
      rating: 5,
    },
    {
      name: "Nomsa Mthembu",
      ...
      content:
        "Finally, accounting software that understands South African business needs. The support team is outstanding.",
      rating: 5,
    },
  ];
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl text-blue-100 max-w-4xl mx-auto mb-8">
                Unified accounting, compliance, and business intelligence
                designed specifically for South African enterprises. SARS-ready,
                CIPC-compliant, and built for growth.
              </p>
              ...
              <div className="flex items-center justify-center gap-x-8 gap-y-2 text-blue-100 flex-wrap">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Comprehensive tools designed specifically for South African
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {features.map((feature, index) => (
                <Link key={index} href={feature.href}>
                  <div className="bg-white p-8 rounded-xl shadow-sm hover:shadow-lg transition-all border border-gray-200 group cursor-pointer h-full">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600">
                Join hundreds of businesses and accounting firms who trust
                Taxnify
              </p>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {pricingPlans.map((plan, index) => {
                const popularStyles = plan.popular
                  ? "border-blue-500 ring-2 ring-blue-200 shadow-xl"
                  : "border-gray-200";
                return (
                  <div
                    key={index}
                    className={`bg-white rounded-xl shadow-lg border-2 p-8 relative ${popularStyles}`}
                  >
                    {plan.popular && (
        ...
        <section className="relative isolate py-20 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-xl text-blue-100 mb-8">
              Join thousands of South African businesses that trust Taxnify for
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              <div className="col-span-1 md:col-span-2">
                ...
                <p className="text-gray-400 mb-6 max-w-md">
                  South Africa&apos;s premier business management platform.
                  Comprehensive accounting, compliance, and business
                  intelligence solutions built for local enterprises.
                </p>
