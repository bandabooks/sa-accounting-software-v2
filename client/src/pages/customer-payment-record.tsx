...
export default function CustomerPaymentRecord() {
  ...
  const createMutation = useMutation({
    mutationFn: async (data: PaymentFormData) => {
      return await apiRequest("/api/customer-payments", "POST", data);
    },
    onSuccess: () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex items-center gap-4 mb-8">
        <Button
          variant="outline"
          onClick={() => setLocation("/customer-payments")}
        ...
        <div>
          <h1 className="text-3xl font-bold">Record Customer Payment</h1>
                        ...
                        <SelectContent>
                          ...
                          {customerInvoices.map((invoice) => (
                            <SelectItem key={invoice.id} value={invoice.id.toString()}>
                              {invoice.invoiceNumber} - R {invoice.total}
                            </SelectItem>
                          ))}
                        </SelectContent>
                      </Select>
