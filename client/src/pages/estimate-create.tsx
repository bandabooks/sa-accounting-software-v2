...
export default function EstimateCreate() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Format data to match server schema for both create and update
    const estimateData = isEditing && existingEstimate ? {
      estimateNumber: existingEstimate.estimateNumber, // Keep existing estimate number when editing
      ...
      estimateNumber: "", // Auto-generated by server for new estimates
      customerId: sanitizedFormData.customerId!,
      issueDate: sanitizedFormData.issueDate,
      expiryDate: sanitizedFormData.expiryDate,
      status: sanitizedFormData.status,
