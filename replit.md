...
**Current Status**: ✅ **Script-Based Auto-Matching Complete (Aug 12, 2025)** - Implemented comprehensive script-based transaction auto-matching system as primary solution for bulk capture. Created ScriptTransactionMatcher with rule-based patterns for South African businesses (salaries, rent, utilities, fuel, bank charges, etc.) with intelligent VAT rate detection (15% vs 0-rated). Added dual auto-match buttons: "Script Auto-Match" (primary, green) and "AI Auto-Match" (secondary, purple) in both expense and income tabs. Script matching provides reliable categorization without AI dependency, automatically selecting chart of accounts and VAT treatment based on transaction descriptions.
