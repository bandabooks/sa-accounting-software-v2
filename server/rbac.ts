...
export const SYSTEM_ROLES = {
  ...
  COMPANY_ADMIN: {
    ...
    description: 'Full administrative access to all company operations and user management',
    level: 8, // Higher than regular admins, but lower than system admins
    permissions: [
      // Dashboard
      PERMISSIONS.DASHBOARD_VIEW,
      
      // User Management - Full access to manage company users
      PERMISSIONS.USERS_VIEW,
      PERMISSIONS.USERS_CREATE,
      PERMISSIONS.USERS_UPDATE,
      PERMISSIONS.USERS_DELETE,
      ...
      // Role Management - Can create and manage company roles
      PERMISSIONS.ROLES_VIEW,
      PERMISSIONS.ROLES_CREATE,
      PERMISSIONS.ROLES_UPDATE,
      PERMISSIONS.PERMISSIONS_GRANT,
