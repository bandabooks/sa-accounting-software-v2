...
export interface AiMatcherStorage {
  ...
  getMatchingPatterns(companyId: number, limit?: number): Promise<AiTransactionPattern[]>;
  updateAiTransactionPattern(id: number, data: Partial<InsertAiTransactionPattern>): Promise<AiTransactionPattern>;
...
export class AiMatcherStorageAdapter implements AiMatcherStorage {
  ...
  async getMatchingPatterns(companyId: number, limit?: number): Promise<AiTransactionPattern[]> {
    return this.storage.getMatchingPatterns(companyId, limit);
  }

  async updateAiTransactionPattern(id: number, data: Partial<InsertAiTransactionPattern>): Promise<AiTransactionPattern> {
